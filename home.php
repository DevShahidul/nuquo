...
<section class="main-content home-content">
    ...
    <script>
        ...
        function onYouTubePlayerAPIReady() {
            player = new YT.Player('ytplayer', {
                ...
                videoId: '<?php global $nuquo; echo $nuquo['hvideo-link'];?>'
            });
        }
    ...
    <!-- Begin hero wrap
==================== -->
    <section class="hero-wrap home-hero" style="background-image: url(<?php echo $nuquo['hero-bgimg']['url'];?>)">
        ...
        <div class="common-wrap">
            <div class="video-wrap">
                <div class="video-inner-wrap clear">
                    ...
                    <div class="video-figure-wrap" id="ytplayer" style="height: 420px; width: 100%;"></div>
                </div>
            </div>
